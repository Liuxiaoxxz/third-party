module github.com/Liuxiaoxxz/third-party/exporter/jvmxexporter

go 1.23.6

require (
	github.com/Liuxiaoxxz/third-party/grpc v0.0.0-20250310064712-b22cbc1738ef
...
//replace github.com/Liuxiaoxxz/third-party/grpc => ../../grpc
